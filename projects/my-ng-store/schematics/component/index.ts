...
export function component(options: ComponentOptions): Rule {
    return async (host: Tree) => {
        ...
        // component selector
        angularComponentOptions.selector = angularComponentOptions.selector ||
            buildSelector(angularComponentOptions, project && project.prefix || '');

        const componentPath = `/${angularComponentOptions.path}/` + (angularComponentOptions.flat ? '' : strings.dasherize(angularComponentOptions.name) + '/');
