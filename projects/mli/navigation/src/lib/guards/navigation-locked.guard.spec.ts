...
import { MyNgState, MyNgStore } from 'my-ng-store';
...
describe('NavigationLockedGuard', () => {
  ...
  let store = {
    state$: new BehaviorSubject<MyNgState>({
      [NavigationStateSpecification.featureStateKey]:
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [{ provide: MyNgStore, useValue: store }],
    });
